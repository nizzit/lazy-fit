...
def build(app: toga.App) -> toga.Box:
    ...
    start_btn = toga.Button(t("start_workout"), on_press=on_start_workout, style=btn_style)
    history_btn = toga.Button(t("history"), on_press=on_history, style=btn_style)
    settings_btn = toga.Button(t("settings"), on_press=on_settings, style=btn_style)

    root = toga.Box(
        children=[start_btn, history_btn, settings_btn],
